  ...
  return (
    <main className="grid min-h-screen place-items-center bg-slate-100 p-6">
      <section className="w-full max-w-xl rounded-2xl border border-rose-200 bg-white p-8 shadow-sm">
        <h1 className="text-2xl font-bold text-rose-700">Registration Rejected</h1>
        <p className="mt-2 text-sm text-slate-600">
          Your account registration was rejected. Please contact support for further assistance.
        </p>
